...
#KROME_init_H2kpd_transition_map
  ...
  subroutine calc_photoBins_thick(n)
    ...
    real*8::photoBinJTab_q(nPhotoRea,nPhotoBins)
...
#ENDIFKROME_usePhotoOpacity
    ...
    photoBinJTab_q(:,:)=photoBinJTab(:,:) !quantum yield x photoXsec
...
#KROME_photobin_opacity
       ...
       do i=1,nPhotoRea
          ...
          if(E>Eth) then
             ...
             kk = photoBinJTab_q(i,j)*Jval*dE*exp(-tauCell(j))
