...
module cooling_module
  ...
  ! In concordance with the primordial initial values in init_flow_fine.f90
  real(kind=8),parameter ::X       = 0.756147541
  real(kind=8),parameter ::Y       = 0.243852459
  real(kind=8),parameter ::rhoc    = 1.8800000d-29
  real(kind=8),parameter ::mH      = 1.6600000d-24
  real(kind=8),parameter ::me      = 9.1093820d-28
